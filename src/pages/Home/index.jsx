        ...
        <div className="flex flex-col border-r bg-background-gray border-zinc-700 text-white" style={{
          ...
          {pastes.map((paste, index) => index < 25 && (
              <a key={paste.id} href={'paste/' + paste.id} className='hover:bg-zinc-800/70 transition duration-150 py-1.5 px-3 mx-2 bg-zinc-800 rounded-lg my-1 flex flex-row'>
                  {paste.password ? (
                      <svg className="fill-zinc-400 h-5 shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96 96">
                          <path d="M78,36H72V24a24,24,0,0,0-48,0V36H18a5.9966,5.9966,0,0,0-6,6V90a5.9966,5.9966,0,0,0,6,6H78a5.9966,5.9966,0,0,0,6-6V42A5.9966,5.9966,0,0,0,78,36ZM36,24a12,12,0,0,1,24,0V36H36ZM72,84H24V48H72Z"/>
                      </svg>
                  ) : (
